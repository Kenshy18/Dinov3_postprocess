...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        self.wandb_mode : str = 'online'
        self.wandb_log_val_images : bool = True
        self.wandb_num_val_images : int = 4
        self.wandb_val_score_thr : float = 0.35

        self.memory_debug_enabled : bool = False
        self.memory_debug_interval : int = 40
        self.memory_debug_stages : List[str] = []
        self.memory_debug_log_file : str = None
        self.memory_debug_to_wandb : bool = False
        self.memory_debug_sync_cuda : bool = True
        self.memory_debug_reset_peak_per_iter : bool = False
