_base_ = [
    '../_base_/datasets/dataset1027_foreground_instance.py',
    '../_base_/default_runtime.py'
]

checkpoint_config = dict(interval=1)
resume_from = None
load_from = '/home/kenke/DINO_CODINO/checkpoint/dinov3_codino_1class_init.pth'
pretrained = None
...
model = dict(
    ...
    backbone=dict(
        ...
        layers_to_use=1,
        pretrained=True,
        weights='/home/kenke/DINO_CODINO/checkpoint/dinov3_vitl16_pretrain_lvd1689m-8aa4cbdd.pth'),
    neck=dict(
        type='SFP',
        in_channels=[1024],
        out_channels=256,
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=('foreground',),
        ann_file='data/dataset1027_tentative_combined_processed/annotations/annotations_train.json',
        img_prefix='data/dataset1027_tentative_combined/',
        pipeline=train_pipeline,
        filter_empty_gt=False),
    val=dict(
        type='CocoDataset',
        classes=('foreground',),
        ann_file='data/dataset1027_tentative_combined_processed/annotations/annotations_val.json',
        img_prefix='data/dataset1027_tentative_combined/',
